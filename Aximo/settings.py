"""
Django settings for Aximo project.
...
WSGI_APPLICATION = 'Aximo.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Points to your static folder where assets like CSS, JS, and images are stored
]