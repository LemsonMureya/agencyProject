...
# Pages routes
    ...
    path('projects/portfolio/', views.portfolio_list, name='portfolio_list'),
    path('projects/portfolio/<int:pk>/', views.portfolio_detail, name='portfolio_detail'),
    ...
    path('checkout/<str:package_id>/', views.create_checkout_session, name='create_checkout_session'),
